...
public class EmployeeServiceServiceLocator extends org.apache.axis.client.Service implements mypackage.EmployeeServiceService {
    ...
    private java.lang.String EmployeeServicePort_address = "http://localhost:9000/HelloWorld";
    ...
    public mypackage.EmployeeService getEmployeeServicePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            mypackage.EmployeeServicePortBindingStub _stub = new mypackage.EmployeeServicePortBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (mypackage.EmployeeService.class.isAssignableFrom(serviceEndpointInterface)) {
                mypackage.EmployeeServicePortBindingStub _stub = new mypackage.EmployeeServicePortBindingStub(new java.net.URL(EmployeeServicePort_address), this);
                _stub.setPortName(getEmployeeServicePortWSDDServiceName());
                return _stub;
            }
        }
